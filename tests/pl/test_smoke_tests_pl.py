...
class PolishSmokeTest(unittest.TestCase):
    ...
    def test_simple_pronoun_plural(self):
        self.compare_annotations('Widziałem psy i one polowały na kota', '[0: [1], [3]]')
    ...
    def test_simple_verb_conjunction_z_different_words(self):
        self.compare_annotations(
            'Widziałem psa z koniem, i polowały na kota', '[0: [1, 3], [6]]',
                excluded_nlps=['core_news_md'])

    def test_simple_pronoun_conjunction_z_different_words(self):
        self.compare_annotations(
            'Widziałem psa z koniem, i one polowały na kota', '[0: [1, 3], [6]]',
                excluded_nlps=['core_news_md'])
    ...
    def test_different_sentence_verb(self):
        self.compare_annotations(
            'Piotra widziałem. Polował na kota', '[0: [0], [3]]')
    ...
    def test_reflexive_simple(self):
        self.compare_annotations(
            'Gepard polował na siebie',
            '[0: [0], [3]]')

    def test_reflexive_coordination(self):
        self.compare_annotations(
            'Gepard i leopard polowały na siebie',
            '[0: [0, 2], [5]]')
    ...
    def test_cataphora_simple_verb(self):
        self.compare_annotations(
             'Dopóki był zmęczony, Piotr został w domu.',
            '[0: [1], [4]]')
    ...
    def test_documentation_example(self):
        self.compare_annotations(
            ...
            '[0: [3], [4], [7], [12], [14], 1: [5], [9], 2: [12, 15], [18], [21], [27], 3: [23], [30]]', excluded_nlps=['core_news_md'])
